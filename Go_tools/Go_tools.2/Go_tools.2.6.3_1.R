...
cat(blue("#--------------------------------------------------------------# \n"))
cat(red("                                      Version: Go_tools.2.6.3 \n"))
cat("                                              Write by Heekuk \n")
...
Go_box_plot <- function(df, metaData, project, orders=NULL, outcomes, statistics = "yes", parametric= "no", star="no",title= NULL, facet= NULL, paired=NULL, name= NULL, xanlgle=90,  height, width, plotCols, plotRows){
...
Go_regression <- function(df, metaData, project, orders, outcomes, pvalue=0.05, des,name=NULL){
  ...
  #meta data
  metadataInput <- read.csv(sprintf("%s",metaData),header=T,as.is=T,row.names=1,check.names=F)
  metadataInput$Chao1 <- c("numeric", "","","","","","","","","","","","","")
  metadataInput$Shannon <- c("numeric", "","","","","","","","","","","","","")
