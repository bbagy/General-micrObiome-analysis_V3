...
cat(blue("#--------------------------------------------------------------# \n"))
cat(red("                                      Version: Go_tools.3.0.7 \n"))
cat("                                              Write by Heekuk \n")
...
# Patescibacteria/
  ...
  num_Actinobacteria = length(grep(col1,cPalette$PhylumCol));num_Actinobacteria
  num_Bacteroidetes = length(grep(col2, cPalette$PhylumCol));num_Bacteroidetes
  num_Firmicutes = length(grep(col3, cPalette$PhylumCol));num_Firmicutes
  num_Fusobacteria = length(grep(col4, cPalette$PhylumCol));num_Fusobacteria
  num_Proteobacteria = length(grep(col5, cPalette$PhylumCol));num_Proteobacteria
  num_Verrucomicrobia = length(grep(col6, cPalette$PhylumCol));num_Verrucomicrobia

  num_TM7 = length(grep(col7, cPalette$PhylumCol));num_TM7
  ...
  cPalette[grep(col1, cPalette$PhylumCol), -1] = expand.grid(h=0.4, s=seq(0.3,1,length.out=num_Actinobacteria), v=0.9)
  
 # Bacteroidetes = purple_pallete
  cPalette[grep(col2, cPalette$PhylumCol), -1] = expand.grid(h=0.8, s=seq(0.3,1,length.out=num_Bacteroidetes), v=0.9) 

    # Firmicutes = blue_pallete
  cPalette[grep(col3, cPalette$PhylumCol), -1] = expand.grid(h=0.6, s=seq(0.3,1,length.out=num_Firmicutes), v=0.9)

  # Fusobacteria = orange_pallete
  cPalette[grep(col4, cPalette$PhylumCol), -1] = expand.grid(h=0.2, s=seq(0.3,1,length.out=num_Fusobacteria), v=0.9)
  

  # Proteobacteria = red_pallete
  cPalette[grep(col5, cPalette$PhylumCol), -1] = expand.grid(h=0, s=seq(0.3,1,length.out=num_Proteobacteria), v=0.9)
  
  # Verrucomicrobia = brown_pallete
  cPalette[grep(col6, cPalette$PhylumCol), -1] = expand.grid(h=0.1, s=seq(0.3,1,length.out=num_Verrucomicrobia), v=1)
  
  # TM7 = yellow_pallete
  cPalette[grep(col7, cPalette$PhylumCol), -1] = expand.grid(h=0.1, s=seq(0.3,1,length.out=num_TM7), v=1)
