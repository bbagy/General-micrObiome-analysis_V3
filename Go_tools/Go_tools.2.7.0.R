...
cat(blue("#--------------------------------------------------------------# \n"))
cat(red("                                      Version: Go_tools.2.7.0 \n"))
cat("                                              Write by Heekuk \n")
...
Go_emptyMap <- function(psIN, project){
  ...
  analysis <- c("type",	"baseline",	"Go_barchart", 	"Go_overview",	"Go_box",	"Go_linear","Go_clme", "Go_reg",	 "Go_bdiv",	"Go_perm","Go_mirkat",	"Go_deseq2","Go_lmem","Confounder")
